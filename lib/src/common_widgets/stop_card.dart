...
class StopCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    var tripState = ref.watch(tripControllerProvider);
    var trip = tripState.value!.getTrip(tripId);
                      ...
                      Opacity(
                        ...
                        child: IconButton(
                          onPressed: () async {
                            ...
                            postHogService.postHogTrackEvent(PosthogTag.userCopiedStopAddress.toSnakeCase, {
                              ...event,
                            });
                            ref
                                .read(httpClientProvider)
                                .telemetryClient
                                .trackEvent(name: "copied_stop_address", additionalProperties: {
                              ...event,
                            });

                            await FirebaseAnalytics.instance
                                .logEvent(name: "copied_stop_address", parameters: {...event});
                          },
