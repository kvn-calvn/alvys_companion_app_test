...
class PlatformChannel {
  ...
  static void startLocationTracking(String driverName, String driverID, String tripNumber, String tripId, String token,
      String url, String companyCode) async {
  ...
  static Future<bool> isTablet() async {
    try {
      return (await platform.invokeMethod("isTablet")) as bool;
    } on PlatformException catch (e) {
      debugPrint(
