...
class Stop with _$Stop {
  ...
  bool canCheckIn(String? checkInStopId) =>
      checkInStopId == stopId && (timeRecord?.driver?.timeIn == null && arrived == null);

  bool canCheckOut(String? checkOutStopId) =>
      checkOutStopId == stopId &&
      (timeRecord?.driver?.timeIn != null && arrived != null) &&
      (timeRecord?.driver?.timeOut == null && departed == null);

  bool canCheckInNew(String? checkInStopId) => checkInStopId == stopId && arrived == null;
  bool get notCheckedIn => timeRecord?.driver?.timeIn == null && arrived == null;
  bool get notCheckedOut => timeRecord?.driver?.timeOut == null && departed == null;
